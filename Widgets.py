...
class Widgets:
    ...
    def display_metrics_line(self, data, method_name):
        if method_name is None:
            dna_mixing_prod_runs = slhelp.get_production_run_count(self=slhelp, data=data, target_column_name=None, target_value=None)
            dna_mixing_success_runs = slhelp.get_successful_run_count(self=slhelp, data=data, target_column_name=None, target_value=None)
    ...
    def display_runs_by_day(self, data, method_name):
        ...
        if method_name is None:
            slhelp.days_per_week_hist(slhelp, data=data ,method_name=None)
        else:
